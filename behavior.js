...
tl.to(".showups", {y: "0%", duration: 1, stagger: 0.40});
tl.to(".slides", {x:"100%", duration: 1.5, delay: 0.3});
tl.to(".intro-animation", {x:"100%", duration: 1.5}, "-=1");
tl.to(".header", {y:"0%", duration: 1.4}, "-=1.8");
